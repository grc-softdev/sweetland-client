...
The system also integrates with a **[react mobile version](https://github.com/grc-softdev/sweetland-mobile)**, enabling waiters and waitresses to view registered products and send customer orders directly to the **kitchen**. The backend is built with **Node.js, Express, Prisma, and PostgreSQL** for handling data and authentication.
